...
* **Instant Sharing:** Draw a box over what you want, hit share, and send it to WhatsApp, Telegram, or any other app instantly.
* **Always Available:** A tiny, unobtrusive 28dp floating button (which fades to 15% opacity when idle) sits over your apps.
* **One-Time Setup:** Uses modern Android Accessibility Services to take screenshots without the annoying "Start Recording" dialog popping up every time you want to capture something.
...
## Why I built this
The "Share" option in Circle to Search has recently disappeared for many Pixel and Galaxy users due to a Google app update. The quickest fix reported was resetting the Google app to factory defaults, but even that doesn't work with the latest Android 17 updates. 
